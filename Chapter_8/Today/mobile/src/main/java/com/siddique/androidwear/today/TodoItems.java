...
public class TodoItems {
    ...
    public static void addItem(Context context, String todoType, String todo) {
        Set<String> todoItems = TodoItems.readItems(context, todoType);
        todoItems.add(todo);
        TodoItems.saveItems(context, todoType, todoItems);
    }
